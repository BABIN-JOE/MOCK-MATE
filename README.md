<div align="center">
  ...
  <h3 align="center">Prepwise: A job interview preparation platform powered by browser-based AI Voice agents</h3>
...
Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, styled with TailwindCSS, and using the browser's Web Speech API for voice features, Prepwise is a website project designed to help you learn integrating AI models with your apps. The platform offers a sleek and modern experience for job interview preparation.
...
👉 **Create Interviews**: Easily generate job interviews with help of browser-based voice assistants and Google Gemini.

👉 **Get feedback from AI**: Take the interview with an AI voice agent (powered by your browser), and receive instant feedback based on your conversation.
